          ...
          class u {
                    ...
                    this.options.plugins &&
                      Object.entries(this.options.plugins).forEach(([t, e]) => {
                        this[t] &&
                          ...
                          ((this[t] = this[t](e, { createElement: a })),
                          e.enabled &&
                            this[t].init &&
            ...
            render(t) {
              ...
              if (
                ...
                this.body ||
                  ((this.body = a("tbody")), this.dom.appendChild(this.body)),
              ...
              if (
                ...
                e.footer
                  ? this.head &&
                    !this.foot &&
                    ((this.foot = a("tfoot", { html: this.head.innerHTML })),
            ...
            renderPager() {
              if ((n(this.pagers), this.totalPages > 1)) {
                ...
                this.options.firstLast &&
                  e.appendChild(r(t, 1, this.options.firstText)),
                  this.options.nextPrev &&
                    !this.onFirstPage &&
                    e.appendChild(r(t, s, this.options.prevText));
                let n = this.links;
                this.options.truncatePager &&
                  ...
                  this.options.nextPrev &&
                    !this.onLastPage &&
                    e.appendChild(r(t, i, this.options.nextText)),
                  this.options.firstLast &&
                    e.appendChild(r(t, this.totalPages, this.options.lastText)),
                  ...
                  if ("txt" === l.type || "csv" === l.type) {
                    for (o = "", n = 0; n < s.length; n++) {
                      for (r = 0; r < s[n].cells.length; r++)
                        if (
                          !l.skipColumn.includes(e[r].originalCellIndex) &&
                    ...
                    for (
                      ...
                      !l.skipColumn.includes(e[n].originalCellIndex) &&
                    ...
                    for (r = 0; r < s.length; r++)
                      for (a[r] = a[r] || {}, n = 0; n < e.length; n++)
                        !l.skipColumn.includes(e[n].originalCellIndex) &&
                          this.columns(e[n].originalCellIndex).visible() &&
                          (a[r][e[n].textContent] = s[r].cells[n].textContent);
